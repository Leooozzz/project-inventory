...
ALTER TABLE "moves" ADD CONSTRAINT "moves_producti_id_products_id_fk" FOREIGN KEY ("producti_id") REFERENCES "public"."products"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
